...
{
    public class MyClaimsPrincipalFactory : UserClaimsPrincipalFactory<Customer, IdentityRole>
    {
        private readonly UserManager<Customer> userManager;
        private readonly RoleManager<IdentityRole> roleManager;
        private readonly IOptions<IdentityOptions> options;

        public MyClaimsPrincipalFactory(UserManager<Customer> userManager, RoleManager<IdentityRole> roleManager, IOptions<IdentityOptions> options) : base(userManager, roleManager, options)
        {
        ...
        protected override async Task<ClaimsIdentity> GenerateClaimsAsync(Customer user)
        {
